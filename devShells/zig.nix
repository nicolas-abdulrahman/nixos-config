...
pkgs.mkShell {
  name = nameNoExt;
  packages = with pkgs ;[ zsh zig zls vscode-extensions.vadimcn.vscode-lldb ];
  LLDB_CODE = "${pkgs.vscode-extensions.vadimcn.vscode-lldb}/share/vscode/extensions/vadimcn.vscode-lldb/adapter";
  shellHook = ''
    export PATH=$LLDB_CODE:$PATH
